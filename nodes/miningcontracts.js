...
module.exports = function(RED) {
  "use strict";
  function MiningContractsNode(config) {
    RED.nodes.createNode(this,config);

    this.apiUrl = "https://www.cryptocompare.com/api/data/miningcontracts";
  ...
  RED.nodes.registerType("miningcontracts", MiningContractsNode);
}